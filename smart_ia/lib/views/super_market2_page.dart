...
class SuperMarket2Page extends StatefulWidget {
  const SuperMarket2Page({super.key});

  @override
  State<SuperMarket2Page> createState() => _SuperMarketPageState();
}

class _SuperMarketPageState extends State<SuperMarket2Page> {
  final String cityName =
      'Santa Rita do Sapucai'; // Substitua pelo nome da cidade
  final String supermarketName =
      'Supermercado B'; // Substitua pelo nome do supermercado
  final String proximidade = '8km';
  ...
  Future<void> loadProductsFromJson() async {
    final jsonString = await rootBundle.loadString('assets/pa_product.json');
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Localização: Rua B, N 456, Bairro C',
                      style: TextStyle(
                        fontSize: 15.0,
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
